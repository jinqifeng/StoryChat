...
public class storyViewAdapter extends RecyclerView.Adapter<storyViewAdapter.ViewHolder> {
    ...
    public storyViewAdapter(Context context, List<chatContents> nStory) {
        this.nStory = nStory;
    ...
    public storyViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
        View v= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.story_view_content_item, parent, false);

        storyViewAdapter.ViewHolder vh = new storyViewAdapter.ViewHolder(v,new MyCustomEditTextListener());
        return vh;
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(storyViewAdapter.ViewHolder holder, final int position) {
        ...
        holder.contents.setKeyListener(null);
        holder.contents.setCursorVisible(false);
        holder.contents.setPressed(false);
